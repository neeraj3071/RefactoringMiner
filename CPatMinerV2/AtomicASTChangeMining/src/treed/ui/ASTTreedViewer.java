...
public class ASTTreedViewer extends Composite implements TreedConstants {
    ...
    public void show() {
        ...
        ast2Trees[0] = new HashMap<>();
        ast2Trees[1] = new HashMap<>();
        tree2ASTs[0] = new HashMap<>();
        tree2ASTs[1] = new HashMap<>();
        ...
        colId.setText("Commit id");
        colMessage.setText("Short message");
        colId.setWidth(getDisplay().getBounds().width / 8);
        colMessage.setWidth(getDisplay().getBounds().width / 8 - 28);
        ...
        colId.setText("New path");
        colMessage.setText("Old Path");
        colId.setWidth(getDisplay().getBounds().width / 8);
        colMessage.setWidth(getDisplay().getBounds().width / 8 - 28);
                ...
                if (path != null && commitId != null) {
                    ...
                    if (gc.connect()) {
                        ...
                        if (commit != null) {
                            ...
                            changedFiles = gc.getChangedFiles(commit, ".cs");
        ...
        for (int i = 0; i < 2; i++) {
            ...
            colEntity.setWidth(getDisplay().getBounds().width / 2 - 85);
            colStatus.setWidth(55);
        }
